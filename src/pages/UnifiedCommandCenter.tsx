...
export default function UnifiedCommandCenter(props: UnifiedCommandCenterProps) {
 ...
 return <CommandCenterShell additionalCommands={[...BUSINESS_MIGRATION_COMMANDS,...CATALOG_NATIVE_COMMANDS,...NATIVE_OPERATIONS_COMMANDS]} onSelectCommand={handleCommand}>
