...
const ConfigurablePOS = lazy(() => import('./components/pos/ConfigurablePOS'));
...
const CommandCenter = lazy(() => import('./pages/UnifiedCommandCenter'));
